...
// Source: js/utils/utilities.js
    var Utils = {
        ...
        isDirect: function(val) {
            if (val.indexOf("direct:") === 0){
                return true;
            }
            return false;
        },
        ...
        changeAttribute: function (attributeName) {
            switch (attributeName) {
                ...
                case 'data-exclude':
                    ...
                    break;
                case 'data-min-date':
                    this.changeAttrMinDate();
                    break;
                case 'data-max-date':
                    this.changeAttrMaxDate();
                    break;
            }
        }
    };
...
// Source: js/plugins/select.js
    var Select = {
        ...
        _createEvents: function () {
            ...
            filter_input.on(Metro.events.blur, function () {
                container.removeClass("focused");
            });
            filter_input.on(Metro.events.focus, function () {
                container.addClass("focused");
            });
            ...
            if (Utils.isValue(format)) {
                ...
                switch (format) {
                    ...
                    case "float":
                        ...
                        break;
                    case "money":
                        data = Number(parseFloat(data.replace(/[^0-9-.]/g, '')));
                        break;
                }
            }
